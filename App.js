...
export default function App() {
  ...
  return (
    ...
    <StatusBar barStyle="dark-content" backgroundColor="#EFE4CE" />
        ...
        <ScrollView style={styles.list} contentContainerStyle={styles.listContent}>
          <View style={styles.switchRow}>
            ...
            <Switch
              ...
              trackColor={{ false: '#C4B79A', true: '#8B2A1E' }}
              thumbColor={enabled ? '#F7EDD5' : '#EFE4CE'}
              ios_backgroundColor="#C4B79A"
            />
          </View>
          ...
          <View style={styles.switchRow}>
            ...
            <Switch
              ...
              trackColor={{ false: '#C4B79A', true: '#5C6E3A' }}
              thumbColor={voiceEnabled ? '#F7EDD5' : '#EFE4CE'}
              ios_backgroundColor="#C4B79A"
            />
          </View>
...
// ----- Palette "Papier russe" -----
// Fond creme comme un vieux carnet, encre brun-noir, accents rouge sombre et or.
const PAGE_BG = '#EFE4CE';        // creme aged paper
const CARD_BG = '#F7EDD5';        // creme legerement plus clair
const CARD_BG_DEEP = '#E4D8B8';   // creme plus profond
const NOTE_BG = '#F0E4C6';        // fond des notes/exemples
const INK_DARK = '#2C1810';       // brun tres fonce (encre)
const INK_MED = '#5C4632';        // brun moyen
const INK_LIGHT = '#8B7355';      // brun clair, muet
const RED_DEEP = '#8B2A1E';       // rouge russe profond
const RED_STRONG = '#6A1F16';     // rouge plus fonce
const GOLD = '#B08D3F';           // or russe
const GOLD_LIGHT = '#D4B266';     // or clair
const OLIVE = '#5C6E3A';          // vert olive (verbes / succes)
const BORDER = '#B8A683';         // tan chaud
const BORDER_SOFT = '#D6C9A8';    // bordure douce
...
const styles = StyleSheet.create({
  ...
  quizOptionCorrect: {
    backgroundColor: '#DDE3C8',
    borderColor: OLIVE,
    borderLeftWidth: 3,
    borderLeftColor: OLIVE,
  },
  quizOptionWrong: {
    backgroundColor: '#E8CDC7',
    borderColor: RED_DEEP,
    opacity: 0.7,
    borderLeftWidth: 3,
    borderLeftColor: RED_DEEP,
